...
const Student = () => {
    ...
    const saveStudent = async (e)=>{
        ...
        await axios.post('http://localhost:8000/api/student/store',formData).then((response)=>{
            getStudents();
    ...
    const updateStudent = async (e)=>{
        ...
        formData.append('class',classname);
         ...
         await axios.post('http://localhost:8000/api/student/update/'+ id,formData).then((response)=>{
            getStudents();
            setModalShow(false)
